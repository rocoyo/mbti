...
const mbtiDescriptions = {
    ...
    INFJ: {
        ...
        image: "images/INFJ.jpg" // 改為全大寫
    },
    INTJ: {
        title: "INTJ（建築師型）",
        traits: "冷靜、理性，富有遠見，擅長長期規劃和戰略思考，對自己的能力充滿自信。",
        strengths: "能夠系統化地解決問題，有清晰的目標和強大的執行力。",
        challenges: "可能過於孤立和強硬，不太關注他人的情感需求。",
        image: "images/INTJ.jpg" // 改為全大寫
    },
    ISTP: {
        title: "ISTP（工匠型）",
